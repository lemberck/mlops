""" This script is the entry point to the FastAPI
 application and will tie everything together."""
...
def predict(text: Text,
    ...
    return Prediction(prediction=prediction_result["label"],
...
def get_texts(name: str = Header(None),
              password: str = Header(None)
              ):
    """
